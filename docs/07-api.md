...
| POST | `/api/scans` | Trois modes : `simulator`, `obd`, **`local`** (mesures relevées par l'application mobile) | Lancer un scan (`mode: obd`\|`simulator`, scénario, symptômes, `analysisMode`) |
